export default class Db {
    static projects = [
        ...
        {id: 2, type: "redBorder", title: "Logo", description: "A creative logo design that represents the engineer samer.", link: "/imgs/eng_samer.jpg", btnText: "See logo"},
    ]
    static customersOpinion = [
        ...
        {id: 2, type: "redColor", langType: "ar", img: "/manImg.jpg", name: "رأي المهندس سامر: ", description: "عاشت أيدك حبي شغلك مرتب و حلو." },
    ]
    static team0 = {
        hassanTahseen: {
            friendsOpinionAr: [
