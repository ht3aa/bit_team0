      ...
      <div className={homeStyles.container}>
        <header id="hero" className={heroStyles.hero}>
          <div className={heroStyles.mainContent}>
            ...
            <h5>In Bit, we have all you need to make your idea comes true. (For now, logo design, programming solutions and building full-stack websites are available)</h5>
